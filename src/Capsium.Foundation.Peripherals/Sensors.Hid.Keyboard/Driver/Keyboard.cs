...
using static Capsium.Foundation.Sensors.Hid.Keyboard.Interop;

namespace Capsium.Foundation.Sensors.Hid;

/// <summary>
/// Encapsulates a standard 108-key keyboard as a Capsium IO Extender
/// </summary>
