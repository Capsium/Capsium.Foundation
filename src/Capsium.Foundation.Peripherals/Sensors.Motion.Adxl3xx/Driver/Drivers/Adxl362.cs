using Capsium.Foundation.Helpers;
using Capsium.Hardware;
using Capsium.Peripherals.Sensors;
using Capsium.Peripherals.Sensors.Motion;
using Capsium.Units;
using System;
using System.Threading;
using System.Threading.Tasks;
using AU = Capsium.Units.Acceleration.UnitType;
using TU = Capsium.Units.Temperature.UnitType;

namespace Capsium.Foundation.Sensors.Motion
{
    /// <summary>
