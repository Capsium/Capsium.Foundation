...
namespace Displays.Tft.Ili9341_Sample
{
    public class CapsiumApp : App<F7FeatherV2>
    {
        ...
        public override Task Run()
        {
            ...
            graphics.DrawTriangle(10, 30, 50, 50, 10, 50, Capsium.Foundation.Color.Red);
            graphics.DrawRectangle(20, 45, 40, 20, Capsium.Foundation.Color.Yellow, false);
            graphics.DrawCircle(50, 50, 40, Capsium.Foundation.Color.Blue, false);
            graphics.DrawText(5, 5, "Capsium F7", Capsium.Foundation.Color.White);
        ...
        void TestDisplay()
        {
            ...
            graphics.DrawText(5, 5, "Capsium F7 SPI", Color.White);
            graphics.Show();
        }
    }
}