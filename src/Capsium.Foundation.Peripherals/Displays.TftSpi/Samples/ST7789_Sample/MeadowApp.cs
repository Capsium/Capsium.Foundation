...
using Capsium.Foundation.Graphics.Buffers;
using System;
    ...
    */
    ...
    public class CapsiumApp : App<F7FeatherV2>
    {
        ...
        void FontScaleTest()
        {
            ...
            graphics.DrawText(0, 240, "Capsium!", Color.Red, ScaleFactor.X2);
        ...
        void ColorFontTest()
        {
            ...
            graphics.DrawTriangle(120, 20, 200, 100, 120, 100, Capsium.Foundation.Color.Red, false);

            graphics.DrawRectangle(140, 30, 40, 90, Capsium.Foundation.Color.Yellow, false);

            graphics.DrawCircle(160, 80, 40, Capsium.Foundation.Color.Cyan, false);

            int indent = 5;
            int spacing = 14;
            int y = indent;

            graphics.DrawText(indent, y, "Capsium F7 SPI ST7789!!");
