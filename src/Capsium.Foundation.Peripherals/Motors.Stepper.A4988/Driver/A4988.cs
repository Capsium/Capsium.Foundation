...
using System;
using System.Linq;
using AU = Capsium.Units.Angle.UnitType;
...
namespace Capsium.Foundation.Motors.Stepper
{
    ...
    public class A4988
    {
        ...
        /// </summary>
        /// <param name="step">The Capsium pin connected to the STEP pin of the A4988</param>
        /// <param name="direction">The Capsium pin connected to the DIR pin of the A4988</param>
        ...
        /// <param name="step">The Capsium pin connected to the STEP pin of the A4988</param>
        /// <param name="direction">The Capsium pin connected to the DIR pin of the A4988</param>
        /// <param name="ms1Pin">The (optional) Capsium pin connected to the MS1 pin of the A4988</param>
        /// <param name="ms2Pin">The (optional) Capsium pin connected to the MS2 pin of the A4988</param>
        /// <param name="ms3Pin">The (optional) Capsium pin connected to the MS3 pin of the A4988</param>
        /// <remarks>You must provide either all of the micro-step (MS) lines or none of them</remarks>
        ...
        /// <param name="step">The Capsium pin connected to the STEP pin of the A4988</param>
        /// <param name="direction">The Capsium pin connected to the DIR pin of the A4988</param>
        /// <param name="enable">The (optional) Capsium pin connected to the ENABLE pin of the A4988</param>
        ...
        /// <param name="step">The Capsium pin connected to the STEP pin of the A4988</param>
        /// <param name="direction">The Capsium pin connected to the DIR pin of the A4988</param>
        /// <param name="enablePin">The (optional) Capsium pin connected to the ENABLE pin of the A4988</param>
        /// <param name="ms1Pin">The (optional) Capsium pin connected to the MS1 pin of the A4988</param>
        /// <param name="ms2Pin">The (optional) Capsium pin connected to the MS2 pin of the A4988</param>
        /// <param name="ms3Pin">The (optional) Capsium pin connected to the MS3 pin of the A4988</param>
        /// <remarks>You must provide either all of the micro-step (MS) lines or none of them</remarks>
