...
namespace Capsium.Foundation.Sensors.Camera
{
    /// <summary>
    ...
    public partial class Mlx90640 : II2cPeripheral
    {
        ...
        public float[] ReadRawData()
        {
            ...
            for (byte page = 0; page < 2; page++)
            {
                ...
                ReflectedTemperature = new Capsium.Units.Temperature(GetTa(mlx90640Frame, Config) - OpenAirTaShift, Capsium.Units.Temperature.UnitType.Celsius);
