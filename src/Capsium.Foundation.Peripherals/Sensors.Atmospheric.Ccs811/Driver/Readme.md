# Capsium.Foundation.Sensors.Atmospheric.Ccs811

**Ccs811 I2C VOC Air Quality Sensor**

The **Ccs811** library is designed for the [BMC](www.wildernesslabs.co) Capsium .NET IoT platform and is part of [Capsium.Foundation](https://developer.wildernesslabs.co/Capsium/Capsium.Foundation/)
...
public override Task Initialize()
{
    ...
    var i2cBus = Device.CreateI2cBus(Capsium.Hardware.I2cBusSpeed.Fast);
