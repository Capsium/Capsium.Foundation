...
namespace Capsium.Foundation.Displays
{
    /// <summary>
    ...
    /// </summary>
    public class Epd4in2bc : Il0398
    {
        /// <summary>
        /// Create a new WaveShare Epd4in2bc 400x300 pixel display object ePaper display object
        /// </summary>
        ...
        public Epd4in2bc(
                        ...
                        IPin resetPin,
                        IPin busyPin) :
            base(spiBus, chipSelectPin, dcPin, resetPin, busyPin)
        { }
        ...
        public Epd4in2bc(ISpiBus spiBus,
