...
namespace Capsium.Foundation.Sensors.Gnss
{
    public partial class NeoM8
    {
        ...
        /// Create a new NEOM8 object
        /// </summary>
        /// <param name="device">ICapsiumDevice instance</param>
        ...
        public NeoM8(ICapsiumDevice device, SerialPortName serialPortName, IPin resetPin, IPin ppsPin = null)
