...
namespace ANONavigationEncoder_Sample
{
    public class CapsiumApp : App<F7FeatherV2>
    {
        ...
        private void RotaryEncoder_Rotated(object sender, Capsium.Peripherals.Sensors.Rotary.RotaryChangeResult e)
        {
            Resolver.Log.Info($"Rotary dial moved: {e.New}");
        }

        private void DirectionalPad_Updated(object sender, ChangeResult<Capsium.Peripherals.Sensors.Hid.DigitalJoystickPosition> e)
        {
