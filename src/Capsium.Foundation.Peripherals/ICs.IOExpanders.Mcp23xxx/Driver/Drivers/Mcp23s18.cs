...
namespace Capsium.Foundation.ICs.IOExpanders
{
    ...
    public class Mcp23s18 : Mcp23x1x
    {
        ...
        /// <param name="resetPort">Optional Capsium output port used to reset the mcp expander</param>
        public Mcp23s18(ISpiBus spiBus, IDigitalOutputPort chipSelectPort, IDigitalInterruptPort? interruptPort = null, IDigitalOutputPort? resetPort = null) :
        ...
        public Mcp23s18(ISpiBus spiBus, IPin chipSelectPin, IPin? interruptPin = null) :
