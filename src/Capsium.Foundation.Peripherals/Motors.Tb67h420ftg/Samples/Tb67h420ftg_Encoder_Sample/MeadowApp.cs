...
using Capsium.Foundation.Sensors.Buttons;
using Capsium.Foundation.Sensors.Rotary;
...
namespace Motors.Tb67h420ftg_Encoder_Sample
{
    public class CapsiumApp : App<F7FeatherV2>
    {
        ...
        private void Encoder_Rotated(object sender, Capsium.Peripherals.Sensors.Rotary.RotaryChangeResult e)
        {
            if (e.New == Capsium.Peripherals.Sensors.Rotary.RotationDirection.Clockwise)
            {
                forwardCount++;
            }
            else
