# Capsium.Foundation.Sensors.Atmospheric.Sht4x

**SHT40, SHT41, SHT45 etc. I2C temperature and humidity sensor**

The **Sht4x** library is designed for the [BMC](www.wildernesslabs.co) Capsium .NET IoT platform and is part of [Capsium.Foundation](https://developer.wildernesslabs.co/Capsium/Capsium.Foundation/)
