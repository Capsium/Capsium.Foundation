...
namespace Displays.Ssd130x.Ssd1309_3DCube_Sample
{
    public class CapsiumApp : App<F7FeatherV2>
    {
        ...
        void CreateSpiDisplay()
        {
            ...
            var config = new Capsium.Hardware.SpiClockConfiguration(new Frequency(12000, Frequency.UnitType.Kilohertz), Capsium.Hardware.SpiClockConfiguration.Mode.Mode0);
