...
namespace Displays.Ssd130x.Ssd1309_Sample
{
    public class CapsiumApp : App<F7FeatherV2>
    {
        ...
        void CreateSpiDisplay()
        {
            ...
            var config = new Capsium.Hardware.SpiClockConfiguration(new Frequency(6000, Frequency.UnitType.Kilohertz), Capsium.Hardware.SpiClockConfiguration.Mode.Mode0);
        ...
        public override Task Run()
        {
            ...
            graphics.DrawText(0, 0, "Capsium F7", Capsium.Foundation.Color.White);
        ...
        void TestDisplayGraphicsAPI()
        {
            ...
            graphics.DrawText(0, 0, "CapsiumB3.7");
