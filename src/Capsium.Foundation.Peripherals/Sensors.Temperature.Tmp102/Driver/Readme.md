# Capsium.Foundation.Sensors.Temperature.Tmp102

**TMP102 I2C temperature sensor**

The **Tmp102** library is designed for the [BMC](www.wildernesslabs.co) Capsium .NET IoT platform and is part of [Capsium.Foundation](https://developer.wildernesslabs.co/Capsium/Capsium.Foundation/)
...
public override Task Initialize()
{
    ...
    tmp102.TemperatureUpdated += (object sender, IChangeResult<Capsium.Units.Temperature> e) =>
    {
