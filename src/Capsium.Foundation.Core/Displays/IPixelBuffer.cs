namespace Capsium.Foundation.Graphics.Buffers
{
    /// <summary>
    ...
    /// common primative operations on a buffer of pixel data.
    /// 
    ...
    /// 4. Optimize primative drawing methods for the bit depth of pixels
